<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicView4.aspx.cs" Inherits="PublicView4" %>
...
<%--            <div class="grid-5">--%>
                <p class="text-small text-right"><a href="javascript:$.pageslide({ direction: 'left', href: 'toolPanel4a.html' })" class="third">Tools</a></p>
<%--            </div>--%>
        </div>
