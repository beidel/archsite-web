            ...
            <LayoutTemplate>
                ...
                <div class="accountInfo">
                    <fieldset class="login">
                        ...
                        <hr />
                        <asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName" CssClass="formTitle" Font-Bold="true">Username:</asp:Label>
                        ...
                        <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="Password"
                            ...
                            ValidationGroup="LoginUserValidationGroup">*</asp:RequiredFieldValidator>
                        <div>
                            <asp:CheckBox ID="RememberMe" runat="server" TabIndex="3" />
                            <asp:Label ID="RememberMeLabel" runat="server" AssociatedControlID="RememberMe" CssClass="inline">Keep me logged in</asp:Label>
                        </div>
                    </fieldset>

                    <p class="submitButton">
                        <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Log In" ValidationGroup="LoginUserValidationGroup" CssClass="form-control" TabIndex="4"/>
                    </p>
