<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicView2.aspx.cs" Inherits="PublicView2" %>
...
<body>
    ...
    <div class="container">
        <div class="grid-6">
            ...
            <p class="text-small text-right"><a href="toolPanel1.html" class="first">Tools</a></p>
        </div>
