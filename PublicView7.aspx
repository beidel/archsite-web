<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicView7.aspx.cs" Inherits="PublicView7" %>
...
<body>
    ...
    <div class="container">
       <div class="grid-6">
            ...
            <p class="text-right text-small"><a href="toolPanel1.html" class="user" rel="panel" id="show">Tool 1</a> | <a href="toolPanel2.html" class="user" rel="panel" id="A1">Tool 2</a></p>
...
<%--        <script type="text/javascript" src="Javascript/jquery-1.7.1.min.js"></script>--%>
        ...
        <script src="Javascript/jquery.codebomber.panel.js"></script> 
